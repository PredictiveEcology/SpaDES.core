...
vignette: >
  ...
  %\VignetteDepends{knitr, NLMR, RColorBrewer, reproducible, SpaDES.core, SpaDES.tools, terra}
...
In general, we feel that a liberal use of `Cache` will make a reusable and reproducible workflow.
...
Let's say there are some GIS operations, like `raster::projectRaster`, which operates on an input shapefile.
