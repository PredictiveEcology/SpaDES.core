...
#'
#' Recursively, runs \code{\link[reproducible]{{objSize}} on the \code{simList} environment, so
#' it estimates the correct size of functions stored there (e.g., with their
#' enclosing environments) plus, it adds
#' all other "normal" elements of the \code{simList}, e.g.,
