...
## new features
* To enable cross-operating-system consistency, several uses of `fastdigest` that were used internally during Caching have been removed as `fastdigest` gives different answers on different operating systems.
