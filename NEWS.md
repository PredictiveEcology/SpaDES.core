...
* new function: `experiment2` which is a more flexible interface to running multiple (parallel) spades calls
* new methods, such as `as.data.table.simLists` to help with outputs from `experiment2`
